...
df3 = pd.read_excel("../data/tickets.xlsx", "Customer Successful", dtype=str, keep_default_na=False)
df4 = pd.read_excel("../data/tickets.xlsx", "Customer Declined", dtype=str, keep_default_na=False)
